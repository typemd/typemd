...
The `name` property is a required system property that serves as the primary display title for all objects in typemd. This specification defines how the name property is managed, populated, and used.
