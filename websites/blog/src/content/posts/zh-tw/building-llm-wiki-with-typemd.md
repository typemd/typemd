...
最近 Tobi Lütke 分享了一個叫 [LLM Wiki](https://github.com/tobi/llm-wiki) 的概念。核心想法是：不要讓 AI 每次回答問題時從頭搜尋文件，而是讓 AI **持續維護一座結構化的知識庫**。每加入一份新資料，AI 就更新摘要、補充交叉引用、標記矛盾。知識是累積的，不是每次重新推導的。
