...
description: Commands for initialization, statistics, configuration, and more.
---

Initialize vaults, view statistics, manage configuration, and start the web server.

| Command | Description |
|---------|-------------|
| [`tmd init`](/cli/init/) | Initialize a new vault |
| [`tmd stats`](/cli/stats/) | Vault-wide summary and per-type property aggregate statistics |
